                ...
                <div className={`absolute right-10 top-[180px]`}>
                    ...
                    <div className={`flex items-center gap-8 ${width >= 1235 ? 'mb-4' : ''}`}>
                        ...
                        <div className={`bg-[#FFE6E6] rounded-br-2xl rounded-tl-2xl ${width < 1350 ? 'w-[500px] h-[100px]' : 'w-[550px] h-[80px]'} p-4`}>
                            <p className={`font-focus text-blue text-[18px]`}>Discover the fascinating world of natural dyes! Engage in discussions about different dye sources and color extraction techniques.</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-8">
                        <div className={`bg-[#FFE6E6] rounded-br-2xl rounded-tl-2xl ${width < 1350 ? 'w-[500px] h-[100px]' : 'w-[550px] h-[80px]'} p-4`}>
                            <p className={`font-focus text-blue text-[18px]`}>Learn how various plants, minerals, and organic materials contribute to the art of natural dyeing.</p>
                        </div>
                ...
                <div className={`mt-16 flex items-end justify-between gap-10 ${width < 1000 ? 'flex-wrap' : ''}`}>
                    <div className={`flex flex-col flex-4`}>
                        ...
                        <div className="flex items-center gap-10">
                            ...
                            <p className={`font-focus text-white text-[18px] text-justify`}>Earn points every time you engage with our community! Participate in discussions, share your dyeing projects, and invite friends to join. Redeem your points for exclusive discounts on our premium natural dye products.</p>
                        </div>
                    </div>
