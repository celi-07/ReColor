    ...
    return (
        <div className={`flex gap-10 p-16 items-center`}>
            ...
            <div className={`flex flex-col ${width <= 600 ? 'items-center' : 'items-start'}`}>
                ...
                <p className={`font-focus text-turqoise text-[18px]`}>Join us in creating a cleaner, greener future for everyone. Small actions lead to big changes—reduce waste, conserve energy, and make sustainable choices every day. Together, we can build a safer and healthier planet for generations to come.</p>
                <InteractiveButton
